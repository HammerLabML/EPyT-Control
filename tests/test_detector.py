"""
Module provides tests to test the `epyt_control.signal_processing.event_detection` module
"""
from epyt_flow.data.benchmarks import load_leakdb_scada_data
from epyt_control.signal_processing.event_detection import SensorInterpolationDetector
